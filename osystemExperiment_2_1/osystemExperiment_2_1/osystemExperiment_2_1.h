...
#include <vector>
#include <Windows.h>
#include "ui_osystemExperiment_2_1.h"
#include "JCB.h"

#pragma comment( lib,"winmm.lib" )
class osystemExperiment_2_1 : public QMainWindow
{
	Q_OBJECT
...
private:
	Ui::osystemExperiment_2_1Class ui;
...
public:
	osystemExperiment_2_1(QWidget *parent = Q_NULLPTR);
	~osystemExperiment_2_1();
