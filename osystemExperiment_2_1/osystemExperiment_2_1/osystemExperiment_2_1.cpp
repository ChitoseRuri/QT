...
osystemExperiment_2_1::osystemExperiment_2_1(QWidget *parent)
	: QMainWindow(parent),
...
osystemExperiment_2_1::~osystemExperiment_2_1()
{
...
void osystemExperiment_2_1::Initialize()
{
...
void osystemExperiment_2_1::UpdateLabel()
{
	...
	while (true)
	{
		...
		//		return pLeft->getTotalTime() - pLeft->getWorkTime() < pRight->getTotalTime() - pRight->getWorkTime(); });//排序
		//}
		m_WorkJCBs[0]->setStatus(JCB::Status::Run);
	}
